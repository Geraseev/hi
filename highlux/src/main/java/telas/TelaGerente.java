...
public class TelaGerente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem1.setText("Adicionar Imovel");
        ...
        jMenuItem2.setText("Editar Imovel");
        ...
        jMenuItem3.setText("Consultar Imovel");
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        TelaGEditarImovel telagerente = new TelaGEditarImovel();
        telagerente.setVisible(true);
    }//GEN-LAST:event_jMenuItem2ActionPerformed

    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        TelaGConsultarImovel telagerente = new TelaGConsultarImovel();
        telagerente.setVisible(true);
